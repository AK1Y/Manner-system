...
export default {
    ...
    methods: {
        ...
        addInfo() {
			if (this.activitiesForm.name.trim() == '') {
			    this.$message({
			        message: "请填写活动名称！",
			        type: "warning",
			    });
			...
			if (this.activitiesForm.activeTime.trim() == '') {
			    this.$message({
			        message: "请输入活动时间！",
			        type: "warning",
			    });
			    return;
			}if (this.activitiesForm.teamId.trim() == '') {
			    this.$message({
			        message: "请选择活动社团！",
			        type: "warning",
			    });
			    return;
			}if (this.activitiesForm.comm.trim() == '') {
			    this.$message({
			        message: "请选择活动概述！",
			        type: "warning",
			    });
			    return;
			}if (this.activitiesForm.ask.trim() == '') {
			    this.$message({
			        message: "请选择活动要求！",
			        type: "warning",
			    });
