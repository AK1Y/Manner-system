...
export default {
    ...
    methods: {
        getPageInfo(pageIndex, pageSize) {
            getPageTeamTypes(pageIndex, pageSize,this.qryForm.token,this.qryForm.name).then((resp) => {
        ...
        getPageLikeInfo() {
            getPageTeamTypes(1, this.pageSize,this.qryForm.token, this.qryForm.name).then(
                (resp) => {
                    this.pageInfos = resp.data.data;
                    this.pageIndex = resp.data.pageIndex;
                    this.pageSize = resp.data.pageSize;
